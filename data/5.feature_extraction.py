...
if __name__ == '__main__':
    ...
    for row in df.itertuples():
        feature = extract_feature(row.password, dict_)

        features['password'].append(row.password)
        features['label'].append(row.label)
        features['number'].append(feature[0])
        features['symbol'].append(feature[1])
        features['upper'].append(feature[2])
        features['lower'].append(feature[3])
        features['repeat'].append(feature[4])
        features['consecutive'].append(feature[5])
        features['in_dict'].append(feature[6])
